...
/***/ (function(module, exports, __webpack_require__) {
	...
	entcore_1.Behaviours.register('moodle', {
	    rights: {
	        workflow: {
	    ...
	    loadResources: function (callback) {
	        return __awaiter(this, void 0, void 0, function () {
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0: return [4 /*yield*/, axios_1.default.get('/moodle/list')];
	                    case 1:
	                        response = _a.sent();
	                        this.resources = response.data.filter(function (e) { return e.trashed === 0; }).map(function (moodle) {
	                        ...
	                        return [2 /*return*/, this.resources];
	                }
	            });
	        });
	    }
